...
export default function ContactPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const formId = process.env.NEXT_PUBLIC_FORMSPREE_ID || "xwpopjrj";
        ...
        <div className="container-custom relative">
          <div className="max-w-3xl">
            <div className="inline-flex items-center gap-3 mb-6">
              ...
              <span className="label-micro">Get in Touch</span>
            </div>
            <h1 className="heading-display text-cream mb-6">
              Contact
              <br />
              <span className="text-gradient-amber">Us</span>
            </h1>
        ...
        <div className="container-custom">
          <div className="grid lg:grid-cols-3 gap-12">
            ...
            <div className="lg:col-span-1">
              <h2 className="font-display text-2xl font-medium text-cream mb-6">
                Contact Information
              </h2>
              ...
              {/* Quick Contact Card */}
              <div className="mt-8 p-6 card-noir">
                    ...
                    <div className="grid md:grid-cols-2 gap-6">
                      ...
                      <div>
                        ...
                        >
                          ...
                          <option value="Membership" className="bg-charcoal">Membership</option>
                          <option value="Breeder Information" className="bg-charcoal">Breeder Information</option>
                          <option value="Buying a Puppy" className="bg-charcoal">Buying a Puppy</option>
                          <option value="Stud Registration" className="bg-charcoal">Stud Registration</option>
        ...
        <div className="container-custom">
          <div className="text-center max-w-3xl mx-auto">
            <h2 className="heading-section text-cream mb-6">
              Serving All of
              <br />
              <span className="text-gradient-amber">South Africa</span>
            </h2>
            ...
            <div className="flex flex-wrap justify-center gap-3">
              {["Gauteng", "Free State", "KwaZulu-Natal", "Western Cape", "Eastern Cape"].map((province) => (
                <span
                  key={province}
                  className="px-4 py-2 bg-white/5 rounded-full text-sm font-medium text-cream border border-white/10"
                >
                  {province}
                </span>
              ))}
