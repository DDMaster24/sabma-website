...
function LoginFormFallback() {
  return (
    <div className="relative sm:mx-auto sm:w-full sm:max-w-md">
      <div className="text-center">
        <div className="w-14 h-14 rounded-2xl bg-warm-200 animate-pulse mx-auto" />
        <div className="mt-6 h-8 bg-warm-200 rounded animate-pulse w-48 mx-auto" />
        <div className="mt-2 h-4 bg-warm-100 rounded animate-pulse w-64 mx-auto" />
      </div>
      <div className="mt-8 bg-white rounded-3xl shadow-soft border border-warm-200 p-8">
        <div className="space-y-6">
          <div className="h-12 bg-warm-100 rounded-xl animate-pulse" />
          <div className="h-12 bg-warm-100 rounded-xl animate-pulse" />
          <div className="h-12 bg-warm-200 rounded-full animate-pulse" />
        </div>
      </div>
    </div>
  )
